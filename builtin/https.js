...
function HTTPOutgoingRequest (port, host, path, method, headers) {
  if (!host.match(/^[0-9.]+$/)) {
...
exports.request = function (opts, onresponse) {
  var req = new HTTPOutgoingRequest(opts.port || 80, opts.hostname, opts.path || '', opts.method || 'GET', opts.headers || {});
