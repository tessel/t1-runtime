...
stream = nil;
method = nil;
if (not _truthy(vary)) then
if res:setHeader(("Vary"), ("Accept-Encoding")) then end;
else
if (not _truthy(_bit.bnot(vary:indexOf(("Accept-Encoding"))))) then
...
if (not _truthy((this).headerSent)) then
...
if _truthy((not _truthy((this).headerSent)) and (getSize(global, chunk) < threshold)) then
compress = (false);
end
...
if (not _truthy(filter(global, req, res))) then
if true then return; end;
end
if (not _truthy(accept)) then
if true then return; end;
end
