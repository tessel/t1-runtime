...
if _truthy((not (isint:test(part))) and isArray(global, obj)) then
...
if _truthy((not (isint:test(key))) and isArray(global, parent.base)) then
t = createObject(global);
...
if _truthy((("=") == c) and (not (brace))) then
