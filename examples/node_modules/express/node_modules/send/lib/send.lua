...
if true then return (not ((this)._root)) and _bit.bnot((this).path:indexOf((".."))); end;
end);
...
if _truthy((not ((this)._hidden)) and this:hasLeadingDot()) then
