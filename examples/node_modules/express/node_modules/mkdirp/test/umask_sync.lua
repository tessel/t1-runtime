...
if test(global, ("umask sync modes"), (function (this, t)
...
if true then return (function () local base, prop = t, "end"; return base[prop](base); end)(); end;
end
...
if t:equal(_bit.band((stat).mode, (511)), _bit.band((511), _bit.bnot(process:umask()))) then end;
