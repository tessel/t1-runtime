...
local Body = _debug.getinfo(1, 'f').func;
(this).x = x;
(this).y = y;
(this).z = z;
(this).vx = vx;
...
local Jupiter = _debug.getinfo(1, 'f').func;
...
local Saturn = _debug.getinfo(1, 'f').func;
...
local Uranus = _debug.getinfo(1, 'f').func;
...
local Neptune = _debug.getinfo(1, 'f').func;
